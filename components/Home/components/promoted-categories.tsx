            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-12">
                    {categories.map((category) => (
                        <div
                            key={category.id}
                            className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-200 text-center w-[190px]"
                        >
                            {/* Image */}
                            <div className="relative w-full h-[140px] bg-gray-50">
                                ...
                                <div className="absolute bottom-[-16px] left-1/2 -translate-x-1/2 bg-white text-gray-800 text-sm font-medium px-5 py-1.5 rounded-full shadow-sm border border-gray-200">
                                    {category.name}
                                </div>
                            </div>
